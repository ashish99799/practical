...
class StatusFilterProductAdapter(
    private var context: Context,
    private val AdapterList: ArrayList<Status>
) : RecyclerView.Adapter<StatusFilterProductAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.ckFilter.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                ...
                context.setStatusList(Gson().toJson(AdapterList))
