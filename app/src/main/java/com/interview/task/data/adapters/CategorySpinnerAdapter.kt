...
class CategorySpinnerAdapter(val context: Context, var dataSource: List<Categorys>) : BaseAdapter() {
...
class CategorySpinnerAdapter(
    ...
    groupid: Int,
    id: Int,
    list: ArrayList<Categorys>
) :
    ArrayAdapter<Categorys>(context, id, list) {
    var groupid: Int
    var list: ArrayList<Categorys>
    ...
    override fun getView(
        ...
        textView.setText(list[position].category)
        return itemView
    }
